 ...
 */
@Config
@Autonomous(name = "Robot Pose and Heading Test", group = "Autonomous Pathing Tuning")
public class RobotPoseHeadingTest extends OpMode {
    ...
    public void init() {
        ...
        telemetryA.addLine("Pull your robot and the motion will be shown on the telemetry.");
        telemetryA.update();
    ...
    public void loop() {
        ...
        telemetryA.addData("X distance moved", poseUpdater.getPose().getX());
        telemetryA.addData("Y distance moved", poseUpdater.getPose().getY());
        telemetryA.addData("Robot Heading",poseUpdater.getPose().getHeading());
        telemetryA.update();
