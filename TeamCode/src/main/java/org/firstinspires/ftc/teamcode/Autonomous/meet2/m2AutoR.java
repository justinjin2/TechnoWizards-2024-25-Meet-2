...
@Autonomous (name = "1plus1", group = "Game" )
public class m2AutoR extends OpMode {
    private Timer pathTimer, opModeTimer, scanTimer;
    public int actionState, clawState;
    ElapsedTime waitTimer1 = new ElapsedTime();
    //waittime1
    int SPEC_DELIVER_ARM_POS = 2650;
    int WALL_INTAKE_POS = 680;
    int DRIVE_ARM_POS = 680;
    //int INTAKEARMPOS = 4735;
    //int SPECARMPOS = 2900;
    //int AFTERSPECDROPPOS = 3200;
    //double WRISTCENTERPOS = 0.33;
    //double INTAKEIN = 0;
    //double INTAKEOUT = 1;
