...
//@Disabled
@Autonomous(name = "leftAuto0+4LF", group = "Auto" )
public class autoYellow0_4LF extends OpMode {
    private Follower follower;
    Arm arm = new Arm();
    Claw claw = new Claw();
    private int clawServoTime = 300;
...
//private Pose wallIntakeAdjustPose = new Pose(130.5, 116, Math.toRadians(0));
    ...
    private Pose parkPose = new Pose(70, 44, Math.toRadians(270));
    private Point parkPoseControl = new Point(80, 9);
    ...
    public void buildPaths() {
        ...
        groundIntake1 = new Path(new BezierLine(new Point(scoreBucketPose), new Point(groundIntakePose1)));
            ...
            case INTAKE_GROUND_START:
                if (clawTimer.milliseconds() > clawServoTime) {
                    if (numberOfDelivery == 1) {
                        ...
                        groundIntake1.setLinearHeadingInterpolation(scoreBucketPose.getHeading(), groundIntakePose1.getHeading());
                    }
