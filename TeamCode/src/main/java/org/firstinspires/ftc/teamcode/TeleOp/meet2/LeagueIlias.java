...
public class LeagueIlias extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        while (opModeIsActive() && !isStopRequested()) {
            ...
            if (currentGamepad1.dpad_up && !previousGamepad2.dpad_up){
                claw.setWrist90();
            }
            if (currentGamepad1.dpad_right && !previousGamepad2.dpad_right){
                claw.setWrist45Right();
            }
            if (currentGamepad1.dpad_left && !previousGamepad2.dpad_left){
                claw.setWrist45Left();
            }
            if (currentGamepad1.dpad_down && !previousGamepad2.dpad_down){
                claw.wristDown();
            }
