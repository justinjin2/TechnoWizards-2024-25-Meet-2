...
public class autoTest5Spec extends OpMode {
    ...
    private Pose scorePose1 = new Pose (110, 80, Math.toRadians(0));
    private Pose scorePose2 = new Pose (109.5, 78, Math.toRadians(0));
    private Pose scorePose3 = new Pose (109.5, 73, Math.toRadians(0));
    private Pose scorePose4 = new Pose (112, 70, Math.toRadians(0));

    private Pose wallIntakePose = new Pose(126.65, 108, Math.toRadians(0));
...
//private Pose wallIntakeAdjustPose = new Pose(130.5, 116, Math.toRadians(0));
    ...
    private Pose endPushPose1 =new Pose(119,pushPickup1ReadyPose.getY(), Math.toRadians(0));

    private Pose pushPickup2ReadyPose = new Pose(87,127, Math.toRadians(0));
    private Pose endPushPose2 =new Pose(119,pushPickup2ReadyPose.getY(), Math.toRadians(0));
    ...
    private Pose endPushPose3 =new Pose(119,pushPickup3ReadyPose.getY(), Math.toRadians(0));
    private Pose pickup3ControlPose = new Pose(112,112, Math.toRadians(0));

    private Pose parkPose = new Pose (126, 114, Math.toRadians(0));
